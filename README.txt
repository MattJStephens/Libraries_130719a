The source code contained in OSGDES_Alpha can be compiled with MS Visual Studio 2010 
It links to the various libraries referenced or in this repository.

Set up Environment variables (Can use OSG_CREATE_ENV_VAR if the libraries correlate)
...
Quite a few environment variables were used to show Visual Studio Compiler/Linker where to find headers and executables. 
